  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans antialiased">
      ...
      <section className="py-24 container max-w-5xl mx-auto px-6">
        ...
        {/* Место для отзывов */}
        <div className="mt-16 rounded-2xl border-2 border-dashed border-white/10 bg-card/50 p-12 text-center">
          <Icon name="MessageSquare" size={32} className="text-muted-foreground mx-auto mb-4" />
          <p className="text-muted-foreground font-medium">Скриншоты отзывов и благодарственных писем</p>
          <p className="text-muted-foreground/50 text-sm mt-1">Этот блок будет заполнен после согласования</p>
        </div>
      </section>
